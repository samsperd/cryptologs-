import { Table, Button, Space, Col, Card, Typography } from 'antd';
...
export default class Cryptocurrenciesy extends Component {
  state = {
    filteredInfo: null,
    sortedInfo: null,
  };
...
<Text className='text-muted' italic>1 day ago</Text>
</Card>
